...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/07/17 12:07:07 by yyasar            #+#    #+#             */
/*   Updated: 2023/08/24 17:39:39 by yyasar           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	print(t_philo *philo, char *str)
{
	...
	if (!philo->table->stop && str[0] == 'd')
		printf("\033[0;36m%llu \033[0;31m%llu %s\033[0m \n", i, philo->id, str);
	else if (!philo->table->stop)
